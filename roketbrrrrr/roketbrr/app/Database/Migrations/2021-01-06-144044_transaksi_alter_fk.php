...
class TransaksiAlterFk extends \CodeIgniter\Database\Migration {
	...
	public function up()
	{
		...
		$this->forge->dropForeignKey('transaksi','transaksi_id_layanan_foreign');
		...
		$this->forge->addColumn('transaksi',[
			'CONSTRAINT transaksi_id_layanan_foreign FOREIGN KEY(id_layanan) REFERENCES layanan(id) ON DELETE NO ACTION ON UPDATE CASCADE',
		]);
	...
	public function down()
	{
		...
		$this->forge->addColumn('transaksi', [
    		'CONSTRAINT transaksi_id_layanan_foreign FOREIGN KEY(id_layanan) REFERENCES layanan(id)',
		]);
