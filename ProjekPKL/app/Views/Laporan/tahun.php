...
<div class="col-12">
        <div class="card">
            ...
            <h3 class="card-title text-center" >Laporan Kegiatan Bongkar Muat <br> Di Pelabuhan Panjang<br>Periode : Januari S/D Desember <?php echo $tahun; ?> </h3>
            <br>
            <div class="table-responsive">
                ...
                <th style="text-align:center">BONGKAR<br>(Box)</th>
                <th style="text-align:center">MUAT<br>(Box)</th>
                <th style="text-align:center">BONGKAR<br>(TEUS)</th>
                <th style="text-align:center">MUAT<br>(TEUS)</th>
                <th style="text-align:center">BONGKAR<br>(Box)</th>
                <th style="text-align:center">MUAT<br>(Box)</th>
                ...
                <th style="text-align:center">BONGKAR<br>(Unit)</th>
                <th style="text-align:center">MUAT<br>(Unit)</th>
                <th style="text-align:center">BONGKAR<br>(Unit)</th>
                <th style="text-align:center">MUAT<br>(Unit)</th>
