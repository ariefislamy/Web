...
<script>
    ...
    <script src="<?php echo base_url() ?>/chart/dist/Chart.min.js"></script>
</head>
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<?php echo base_url() ?>/assets/images/ksop.png" alt="homepage" class="dark-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span>
                         <!-- dark Logo text -->
                         <img src="<?php echo base_url() ?>/assets/images/nama(side).png" alt="homepage" class="dark-logo" />
                         <!-- Light Logo text -->    
                         <img src="<?php echo base_url() ?>/assets/images/nama(side).png" class="light-logo" alt="homepage" /></span> </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                <!-- ============================================================== -->
